...
class dataset(Dataset):
    def __init__(self, type='news', train=True, shuffle=True):
        ...
        if type == 'news':
            if train:
                self.filename = 'FinalCode/Data/news/train_data_pytorch.csv'
            else:
                self.filename = 'FinalCode/Data/news/test_data_pytorch.csv'
            ...
            self.vocab_filename = 'FinalCode/Data/news/train_data_pytorch.csv'
            ...
            if train:
                self.filename = 'FinalCode/Data/toxic/train.csv'
            else:
                self.filename = 'FinalCode/Data/toxic/test.csv'
            self.data = pd.read_csv(self.filename, names=['content', 'class'])
            
            self.vocab_filename = 'FinalCode/Data/toxic/train.csv'
